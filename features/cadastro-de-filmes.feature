...
Funcionalidade: Cadastro de filmes
    ...
    @dup_movie
    Cenario: Duplicado
        O gestor de catalogo tenta cadastrar um filme, porém o título 
        já foi cadastrado e outro momento e o sistema notifica o usuario
        informado que o título já existe.
